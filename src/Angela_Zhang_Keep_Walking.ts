  ...
  get lines() {
    return [
      ...
      },
      {
        ...
        startMs: 30000,
        endMs: 32000,
        ...LYRICS_DICT["很确定我想去哪里"],
      },
      {
        id: "line-06",
        startMs: 32000,
        endMs: 34500,
        ...LYRICS_DICT["往天堂要跳过地狱"],
      },
      {
        id: "line-07",
        startMs: 34500,
      ...
      },
      {
        ...
        startMs: 62000,
        endMs: 65000,
        ...LYRICS_DICT["是一颗宝石就该闪烁"],
      },
      {
        id: "line-13",
        startMs: 65000,
        endMs: 67500,
        ...LYRICS_DICT["人都应该有梦Oh~"],
      },
      {
        id: "line-13a",
        startMs: 67500,
      ...
      },
      {
        ...
        startMs: 82500,
        endMs: 86000,
        ...LYRICS_DICT["有前面盘旋的秃鹰"],
      },
      {
        id: "line-17",
        startMs: 86000,
        endMs: 88500,
        ...LYRICS_DICT["有背后尖酸的耳语"],
      },
      {
        id: "line-18",
        startMs: 88500,
...
const LYRICS_DICT = {
  "Oh~人都应该有梦": {
    translation: {
      ...
      pl: "Oh~ Wszyscy ludzie powinni mieć marzenia",
    },
    words: [
  ...
  有梦就别怕痛: {
    ...
    words: [
      ...
      { hanzi: "别", pinyin: "bié", translation: { en: "do not", pl: "nie" } },
    ...
    words: [
      {
        hanzi: "有",
        pinyin: "yǒu",
        translation: { en: "there is", pl: "jest/są" },
      },
      {
        hanzi: "雷声",
        pinyin: "léishēng",
